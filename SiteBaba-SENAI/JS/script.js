...
const cadastroBaba = document.querySelector("#cadastroBaba");
console.log(cadastroBaba)
if (cadastroBaba !== null) {
  cadastroBaba.addEventListener("submit", (evt) => {
    console.log("oii") 
   return cadastraBaba(evt);
  });
}

// função para cadastrar os responsáveis (CRUD);
function cadastraPais(evt) {
...
if (cadastroPais !== null) {
  cadastroPais.addEventListener("submit", (evt) => {
    return cadastraPais(evt);
  });
}

// função para logar os usuários (CRUD);
function logaUsuario(evt) {
  evt.preventDefault(evt);
...
if (Login !== null) {
  Login.addEventListener("submit", (evt) => {
    return logaAdmin(evt) || logaUsuario(evt);
  });
}
...
function modificar_imagem_de_perfil_baba() {
  ...
  element_opcao_de_imagens.innerHTML = `
    ...
    <button onclick="mudar_imagem_tres_baba()"><img src="ip_3.png"></button>
...
function mudar_imagem_um_baba() {
  ...
  element_nav_img_usuario.src = `ip_1.png`;
  let pegar_object;
  let user_logado;
  ...
  for (i = 0; validacion == false; i++) {
    if (pegar_object[i].email == user_logado.email) {
      pegar_object[i].imagem_de_perfil = `ip_1.png`;
      ...
      element_imagem_de_usuario.src = `ip_1.png`;
      element_nav_img_usuario.src = `ip_1.png`;
    }
  }
  window.onload();
...
function mudar_imagem_dois_baba() {
  let element_imagem_de_usuario = document.getElementById(`imagem_de_usuario`);
  let element_nav_img_usuario = document.getElementById(`nav_img_usuario`);
  element_nav_img_usuario.src = `ip_2`;
  let pegar_object;
  let user_logado;
  let validacion = false;
  user_logado = JSON.parse(localStorage.getItem(`User Logado`));
  ...
  for (i = 0; validacion == false; i++) {
    if (pegar_object[i].email == user_logado.email) {
      pegar_object[i].imagem_de_perfil = `ip_2.png`;
      ...
      element_imagem_de_usuario.src = `ip_2.png`;
      element_nav_img_usuario.src = `ip_2.png`;
    }
  }
  window.onload();
}
...
function mudar_imagem_tres_baba() {
  let element_imagem_de_usuario = document.getElementById(`imagem_de_usuario`);
  let element_nav_img_usuario = document.getElementById(`nav_img_usuario`);
  element_nav_img_usuario.src = `ip_3.png`;
  let pegar_object;
  let user_logado;
  let validacion = false;
  user_logado = JSON.parse(localStorage.getItem(`User Logado`));
  ...
  for (i = 0; validacion == false; i++) {
    if (pegar_object[i].email == user_logado.email) {
      pegar_object[i].imagem_de_perfil = `ip_3.png`;
      ...
      element_imagem_de_usuario.src = `ip_3.png`;
      element_nav_img_usuario.src = `ip_3.png`;
    }
  }
  window.onload();
...
function mudar_imagem_quatro_baba() {
  let element_imagem_de_usuario = document.getElementById(`imagem_de_usuario`);
  let element_nav_img_usuario = document.getElementById(`nav_img_usuario`);
  element_nav_img_usuario.src = `ip_4.png`;
  let pegar_object;
  let user_logado;
  let validacion = false;
  user_logado = JSON.parse(localStorage.getItem(`User Logado`));
  ...
  for (i = 0; validacion == false; i++) {
    if (pegar_object[i].email == user_logado.email) {
      pegar_object[i].imagem_de_perfil = `ip_4.png`;
      ...
      element_imagem_de_usuario.src = `ip_4.png`;
      element_nav_img_usuario.src = `ip_4.png`;
    }
  }
  window.onload();
...
function on_load_imagem_de_perfil_edicao_baba() {
  ...
  for (i = 0; validacao == false; i++) {
    console.log(pegar_localStorage_baba[i].email);
    if (
